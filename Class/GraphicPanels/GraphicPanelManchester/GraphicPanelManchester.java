...
public class GraphicPanelManchester extends JPanel {
	
	private String binaryCode;
	
	public GraphicPanelManchester (String binaryCode) {
	...
	public void paintComponent (Graphics graphics) {
		...
		int abscissa1, abscissa2, ordonate1, ordonate2;
		...
		for (int i = 0; i < point.length; i++) {
			...
			if (point [i].getPositionY () == 1) {
				...
				ordonate2 = getHeight () - 30;
			
			} else {
				
				ordonate1 = getHeight () - 30;
